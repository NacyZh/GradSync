...
urlpatterns = [
    ...
    path("api/admin/role-activations", RoleActivationListView.as_view(), name="contract-role-activation-list"),
    path("api/admin/role-activations/<int:pk>", RoleActivationDetailView.as_view(), name="contract-role-activation-detail"),
