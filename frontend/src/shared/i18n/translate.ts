...
const apiMessages: Record<string, string> = {
  ...
  'Recovery instruction is invalid or expired.': '账号找回说明无效或已过期。',
  'Email change instruction is invalid or expired.': '邮箱变更验证无效或已过期。',
  'New email must be different from the current email.': '新邮箱不能与当前邮箱相同。',
  'This email change is already pending.': '该邮箱变更已在等待验证。',
  'No active email change request exists.': '当前没有等待验证的邮箱变更。',
  'End the current session through sign out.': '请通过退出登录结束当前会话。',
